...
export interface BeanstalkUbean3CrvInterface extends utils.Interface {
  functions: {
...
export interface BeanstalkUbean3Crv extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BeanstalkUbean3CrvInterface;
